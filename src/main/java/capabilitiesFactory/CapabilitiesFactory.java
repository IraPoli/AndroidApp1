...
public class CapabilitiesFactory {
    ...
    private static final String DEVICE_NAME_CAPABILITY = "Pixel 4 API 25";
    private static final String UDID_NAME_CAPABILITY = "emulator-5554";
    ...
    public static DesiredCapabilities getCapabilities(){
        ...
        capabilities.setCapability(MobileCapabilityType.UDID,UDID_NAME_CAPABILITY);
